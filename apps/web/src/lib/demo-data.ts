...
export const demoAgentProposals: AgentProposal[] = [
  {
    id: id("prop", 1),
    pattern_type: "stale_pr",
    title: "Stale PR: [backend] #287 Fix token refresh rotation",
    description: "This pull request has been open for 5 days. Consider pinging the reviewer or adding a review request.",
    suggested_action: 'Comment on PR #287: "This PR has been open for 5 days. @sara-kim — please review or let us know if it\'s blocked."',
    tool: "github",
    confidence: 0.82,
    priority: "high",
    status: "pending",
    entity_ids: [id("ent", 3)],
    context_snapshot: { source_url: "https://github.com/acme/backend/pull/287", age_days: 5 },
    delegation_id: null,
    created_at: ago(45),
  },
  {
    ...
    title: "Blocked: [AUTH-142] JWT token refresh bug",
    description: "This ticket is flagged as blocked. Status: In Progress. Consider escalating to the team lead.",
    suggested_action: 'Comment on AUTH-142: "This ticket is blocked. Escalating for team lead attention. Current status: In Progress."',
    tool: "jira",
    confidence: 0.88,
    priority: "high",
    status: "pending",
    entity_ids: [id("ent", 1)],
    context_snapshot: { source_url: "https://acme.atlassian.net/browse/AUTH-142", status: "In Progress", labels: ["blocked"] },
    delegation_id: null,
    created_at: ago(30),
  },
  {
    ...
    title: "No reviewer: [backend] #290 Rate limiter middleware",
    description: "This PR has been open for 2 days with no reviewer assigned. Consider requesting a review.",
    suggested_action: "Request review on PR #290 from a team member. PR has been open 2 days with no reviewer.",
    tool: "github",
    confidence: 0.71,
    priority: "medium",
    status: "pending",
    entity_ids: [id("ent", 8)],
    context_snapshot: { source_url: "https://github.com/acme/backend/pull/290", age_days: 2 },
    delegation_id: null,
    created_at: ago(20),
  },
  {
    ...
    title: "Idle: [PLAT-98] API rate limiting",
    description: "This sprint item has been in 'To Do' for 4 days without updates. Sprint: Sprint 24.",
    suggested_action: 'Comment on PLAT-98: "This sprint item has been idle for 4 days in \'To Do\'. Sprint: Sprint 24. Does it need to be re-scoped or reassigned?"',
    tool: "jira",
    confidence: 0.67,
    priority: "medium",
    status: "pending",
    entity_ids: [id("ent", 6)],
    context_snapshot: { sprint: "Sprint 24", status: "To Do", idle_days: 4 },
    delegation_id: null,
    created_at: ago(15),
  },
  {
    id: id("prop", 5),
    pattern_type: "stale_pr",
    title: "Stale PR: [backend] #281 PKCE implementation",
    description: "This PR was approved and merged. Agent auto-resolved.",
    suggested_action: 'Ping reviewer on PR #281.',
    tool: "github",
    confidence: 0.76,
    priority: "medium",
    status: "approved",
    entity_ids: [id("ent", 4)],
    context_snapshot: { source_url: "https://github.com/acme/backend/pull/281" },
    delegation_id: id("del", 1),
    created_at: ago(60 * 24),
  },
  {
    id: id("prop", 6),
    pattern_type: "missed_deadline",
    title: "Overdue: Database connection pooling",
    description: "Rejected — deadline was intentionally extended.",
    suggested_action: 'Comment on PLAT-95: "This task is 2 days overdue."',
    tool: "jira",
    confidence: 0.84,
    priority: "critical",
    status: "rejected",
    entity_ids: [id("ent", 9)],
    context_snapshot: { days_overdue: 2 },
    delegation_id: null,
...
export const demoAgentStats: AgentStats = {
  total_proposals: 6,
  by_status: { pending: 4, approved: 1, rejected: 1, dismissed: 0, executed: 0 },
  by_pattern: { stale_pr: 2, blocked_ticket: 1, unreviewed_pr: 1, idle_sprint_item: 1, missed_deadline: 1 },
  approval_rate: 16.7,
  learning: {
    patterns: {
      stale_pr: { total: 8, approved: 6, rejected: 2, approval_rate: 0.75 },
      blocked_ticket: { total: 4, approved: 3, rejected: 1, approval_rate: 0.75 },
      missed_deadline: { total: 3, approved: 1, rejected: 2, approval_rate: 0.333 },
      unreviewed_pr: { total: 2, approved: 2, rejected: 0, approval_rate: 1.0 },
      idle_sprint_item: { total: 5, approved: 3, rejected: 2, approval_rate: 0.6 },
    },
    total_feedback: 22,
    overall_approval_rate: 0.682,
...
export const demoAgentConfig: AgentConfigData = {
  enabled: true,
  mode: "balanced",
  confidence_threshold: 0.6,
